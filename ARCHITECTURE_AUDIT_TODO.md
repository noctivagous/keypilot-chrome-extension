...
- [ ] Tree-shake unused highlight/RBush after product decision
- [ ] Single hover/targeting architecture with one primary path
...
- [ ] Unused RBush vendor path if DOM-hover-only
...
| `intersection-observer-manager.js` | 2525 | Dual hover paths |
