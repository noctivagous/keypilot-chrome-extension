...
Leave untagged: KeyPilot, Noctivagous Software, the store URL, the email, QWERTY legends, `noctivagous.com` in the fake browser chrome, and native language names in the switcher.
