/**
 * ARCHIVED — manual concat bundler (pre-esbuild).
 * Default build is extension/build.js (esbuild). See README.md in this folder.
 * Restore via: npm run build:manual
 */
...
const modules = [
  ...
  // NCT dark UI tokens must precede overlay-manager / popovers / control strip (import-stripped IIFE).
  'src/ui/nct-dark-ui.js',
