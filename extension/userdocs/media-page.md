...
Page Media scans the current page for images, videos, text, documents, and URLs so you can browse or save them without inspecting the page manually.

## Use it

1. Press <kbd>O</kbd> on the default right-handed Browsing layout.
2. Switch tabs: **Image**, **Video**, **Text**, **Docs**, **URLs**.
