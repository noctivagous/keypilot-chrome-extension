...
La configuración controla la apariencia, el desplazamiento, el motor de búsqueda, la Control Strip y la familia de teclados que utiliza. Los cambios se sincronizan entre pestañas en el mismo perfil de Chrome.
...
| Sección | Lo que configuras |
| --- | --- |
| [**Descripción general**](kp://settings/overview) | Hub vinculado a cada categoría |
| [**Apariencia**](kp://settings/appearance) | Tema y cromo visual |
...
| [**Acerca de**](kp://settings/about) | Notas de almacenamiento y sincronización para este perfil de Chrome |

### Superficies relacionadas

- La reasignación profunda de teclas se encuentra en el **Editor de distribución del teclado** (<kbd>Alt</kbd>+<kbd>C</kbd>), no en Configuración. Consulte [Editor de distribución de teclado](kp://docs/layout-config).
- La documentación es <kbd>Alt</kbd>+<kbd>H</kbd>; La breve página de la Guía permanece disponible desde varios puntos de entrada de Chrome.
